...
1. Solicitação de leitura integral do PDF e criação do plano/checklist.
2. Confirmação da autorização para 8 integrantes, reserva e repositório da equipe.
3. Solicitação para a IA tomar decisões de estrutura, relatório e organização de evidências.
4. Solicitação para iniciar a execução dos casos de teste e consultar a equipe quando necessário.
5. Definição de rodízio de um ou dois revisores humanos por caso, envolvendo todos os integrantes.

## Sugestões e verificações

| Sugestão da IA | Tratamento | Verificação necessária |
|---|---|---|
